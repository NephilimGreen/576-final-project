...
public class MazeGenerator : MonoBehaviour
{
    ...
    private string[][] specialFloorTypes = { digits, operators, traps, boosts };
    ...
    public string[][,][] Generate()
    {
        ...
        operatorMinumums = new[] { addMinCount, subtractMinCount, multiplyMinCount, divideMinCount };
        trapPercentages = new[] { pitPercentage, poofPercentage };
        trapMinumums = new[] { pitTrapsMinCount, poofTrapsMinCount };
        boostPercentages = new[] { healthPercentage, speedPercentage };
        boostMinumums = new[] { healthMinCount, speedMinCount };
        specialFloorPercentages = new[] { digitPercentages, operatorPercentages, trapPercentages, boostPercentages };
        specialFloorCounts = new[] { digitCounts, operatorCounts, trapCounts, boostCounts };
        specialFloorMinimums = new[] { digitMinimums, operatorMinumums, trapMinumums, boostMinumums };
        start = ((width - 1) / 2, 0);
