...
public class Minimap : MonoBehaviour
{
    ...
    public void mapDraw(int floor, string[,][] grid)
    {
        ...
        byte[] imageData = File.ReadAllBytes(pathToMinimapBackground);
        ...
        File.WriteAllBytes("C:/Users/Ryan/Desktop/Unity Projects/576 Final Project/Assets/Resources/" + imgObject.name + ".png", wholeMap.EncodeToPNG());
